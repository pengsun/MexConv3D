...
void conv3d_blas_gpu::vol_from_convmat(xpuMxArrayTW &pvol, mwSize iInst)
{
...
////
template<conv3d_blas_gpu::DIR how> 
void conv3d_blas_gpu::cpy_convmat_vol (xpuMxArrayTW &pvol, mwSize iInst)
{
  // v: [H,   W,   D,   P]
  // F: [H',  W',  D',  P]
  // Y: [H'', W'', D'', 1]
